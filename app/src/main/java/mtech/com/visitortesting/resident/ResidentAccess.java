...
public class ResidentAccess extends Activity implements MFS100Event {
    ...
    protected void onStart(){
        if (mfs100 == null){
            ...
            mfs100.SetApplicationContext(ResidentAccess.this);
        } else {
            InitScanner();
        }
        super.onStart();
    ...
    public void onControlClicked(View v){
        switch (v.getId()){
            ...
            case R.id.btnSyncCapture:
                ...
                if (!isCaptureRunning){
                    StaffID = staffCode.getText().toString();
...
//                        createDirectoryAndSaveFile(bitmap,"Template");
                        ...
                        ResidentAccess.this.runOnUiThread(new Runnable(){
                            @Override
                            public void run() {
...
//            }
    ...
    public class GetLongLat extends AsyncTask<String, String, String> {
        ...
        protected void onPreExecute() {
            progressDialog = new ProgressDialog(ResidentAccess.this);
            ...
            try {
                ...
                if (conn == null){
                    ...
                    if (flag.equalsIgnoreCase("U")){
                        PreparedStatement stmt = conn.prepareStatement("insert into MFSTestTemplate" + "("+finger+",StaffId)" + " values(?,?)");
