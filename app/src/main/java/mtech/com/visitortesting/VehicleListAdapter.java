...
public class VehicleListAdapter extends ArrayAdapter<String> {
    ...
    public VehicleListAdapter(Activity context, ArrayList<String> maintitle, ArrayList<String> subtitle, ArrayList<String> vehicle, ArrayList<String> EDate, ArrayList<String> purpose, ArrayList<String> active) {
